...
urlpatterns = [
    ...
    path('api/packet_replay/start', views.api_packet_replay_start, name='api_packet_replay_start'),
    path('api/packet_replay/stop', views.api_packet_replay_stop, name='api_packet_replay_stop'),
    path('api/packet_replay/status', views.api_packet_replay_status, name='api_packet_replay_status'),
    ...
    path('api/industrial/goose_sv/<path:action>/', views.api_industrial_goose_sv, name='api_industrial_goose_sv'),
